let chardb = require('../assets/dataBases/characters');
let planetsdb = require('../assets/dataBases/planets');
let speciesdb = require('../assets/dataBases/species');
let starshipsdb = require('../assets/dataBases/starships');
let vehiclesdb = require('../assets/dataBases/vehicles');
let charList = [];
let planetList = [];
let speciesList = [];
let starshipsList = [];
